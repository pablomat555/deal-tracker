...
TRANSLATIONS = {
    'ru': {
        ...
        'filter_by_exchange': "Фильтр по бирже/счету",
        'filter_by_asset': "Фильтр по символу",
        ...
        'col_close_time': "Дата закрытия",
        'col_buy_price': "Куплено по",
        'col_sell_price': "Продано по",
        ...
        'no_open_positions_to_display': "Нет открытых позиций для отображения.",
    ...
    'en': {
        ...
        'filter_by_exchange': "Filter by exchange/account",
        'filter_by_asset': "Filter by symbol",
        ...
        'no_open_positions_to_display': "No open positions to display.",
        ...
        'no_closed_deals_after_filter': "No closed deals matching the filters.",
